        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {highlights.map((item, index) => (
              <div
                key={index}
                className="card-cyber p-6 transition-all duration-300 hover:border-primary/50 hover:-translate-y-1"
              >
                <item.icon className="w-10 h-10 text-primary mb-4" />
                <h3 className="terminal-text text-lg font-semibold text-foreground mb-2">
                  {item.title}
                </h3>
